import { associationIdentity, clientLNIdentity, connectedAPIdentity, controlBlockIdentity, enumValIdentity, extRefIdentity, fCDAIdentity, hitemIdentity, idNamingIdentity, iEDNameIdentity, ixNamingIdentity, kDCIdentity, lDeviceIdentity, lNIdentity, lNodeIdentity, namingIdentity, physConnIdentity, pIdentity, protNsIdentity, sCLIdentity, singletonIdentity, terminalIdentity, valIdentity, } from './identity.js';
import { associationSelector, clientLNSelector, connectedAPSelector, controlBlockSelector, enumValSelector, extRefSelector, fCDASelector, hitemSelector, idNamingSelector, iEDNameSelector, ixNamingSelector, kDCSelector, lDeviceSelector, lNodeSelector, lNSelector, namingSelector, physConnSelector, protNsSelector, pSelector, sCLSelector, singletonSelector, terminalSelector, valSelector, voidSelector, } from './selector.js';
export const tags = {
    AccessControl: {
